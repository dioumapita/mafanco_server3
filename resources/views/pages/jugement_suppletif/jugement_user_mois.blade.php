...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Jugement suppletif par mois</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                    href="#"></a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li class="active">Jugement suppletif par mois</li>
        </ol>
    </div>
</div>
<div class="row">
            ...
            <div class="card-head">
                <header>
                    Jugement suppletif du mois
                        ...
                        @endif
                        <br><br>
                    Nbres d'utilisateurs: {{ $all_jugement_suppletifs->count() }}
                </header>
                <div class="tools">

...
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>
                    Jugement Suppletif du {{ date('d/m/').$annee }}
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        &nbsp;
                        @can('Crée un jugement antidate')
                            <a href="{{ route('create_jugement_anti') }}" class="btn btn-danger">Crée un jugement urgent <i class="fa fa-plus"></i></a>
                        @endcan
                        &nbsp;
                        ...
                        <a href="{{ route('all_jugement') }}" class="btn btn-primary">Affiche Tout</a>
                        <!-- debut modal -->

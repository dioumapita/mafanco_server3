...
<div class="page-bar">
 ...
 <a href="{{ route('gest_appel.index') }}" class="btn btn-primary"><i class="fa fa-reply"></i> Retour</a>
                    ...
                    <div class="card">
                        ...
                        <div class="white-box">
                            ...
                            {{-- @if($appel->docAppels->count() > 0) --}}
                                <iframe  src="/uploads/gest/appels/{{ $appel->id.'.pdf' }}" width="600" height="700" alt="pdf">
                                </iframe>
                        </div>
                    </div>
                </div>

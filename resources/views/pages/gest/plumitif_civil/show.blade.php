...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Détail d'un plumitif civil</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Détail d'un plumitif civil</li>
        </ol>
    </div>
</div>
 <a href="{{ route('gest_plumitif_civil.index') }}" class="btn btn-primary"><i class="fa fa-reply"></i> Retour</a>
                    ...
                    <div class="card">
                        ...
                        <div class="white-box">
                            ...
                            {{-- @if($appel->docAppels->count() > 0) --}}
                                <iframe  src="/uploads/gest/p_civils/{{ $plumitif->id.'.pdf' }}" width="600" height="700" alt="pdf">
                                </iframe>
                        </div>
                    </div>
                </div>

...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Liste des Périodes Normales</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                    href="#"></a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li class="active">Liste des périodes Normales</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>Liste des périodes normales</header>
                <div class="tools">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <!-- start modal body -->
                                            <div class="modal-body">
                                                    <form action="{{ route('periode_normal.store') }}" method="post">
                                                        {{ csrf_field() }}
                                            ...
                                            <div class="mt-5 modal-dialog modal-confirm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        ...
                                                        <form action="{{ route('periode_normal.destroy',$periode->id) }}" method="post" id="deleteform">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
                                            ...
                                            <div class="modal fade" data-backdrop="static" id="edit_periode{{ $periode->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- start modal body -->
                                                            <div class="modal-body">
                                                                    <form action="{{ route('periode_normal.update',$periode->id) }}" method="post">
                                                                        {{ csrf_field() }}
                                                                        {{ method_field('PUT') }}
                                                                        <div class="form-group">
                                                                            <label for="num_debut">Numéro Début *</label>
                                                                            <input type="number"
                                                                                class="form-control" name="num_debut" id="num_debut" value="{{ $periode->debut }}"  required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="mois">Selectionner le mois</label>
                                                                            <select  class="form-control" name="mois" id="mois" required>
...
<script type="text/javascript">
    function deleteData(id)
        {
            var id = id;
            var url = '{{ route("periode_normal.destroy", ":id") }}';

...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Casier judiciaire par jour</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                    href="#"></a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li class="active">Casier judiciaire par jour</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>
                    Casier judiciaire du {{ $date }} <br><br>
                        ...
                        <tbody>
                            @foreach ($all_casiers as $casier)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $casier->user->prenom.' '.$casier->user->nom }}</td>

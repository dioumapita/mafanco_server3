...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Certificat de nationalité par mois</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                    href="#"></a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li class="active">Certificat de nationalité par mois</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>
                    Certificat de nationalité pour le mois
                    @if ($num_mois == 1)
                        {{ "de janvier" }}
                    @elseif($num_mois == 2)
                        {{ "de fevrier" }}
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <a href="{{ route('certificat_nationalite.create') }}" class="btn btn-danger">Crée un certificat <i class="fa fa-plus"></i></a>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div  class="modal-header btn btn-danger text-center text-white">
                                        <h4 class="modal-title white-text w-100 font-weight-bold py-2">Afficher les certificats par mois</h4>
                                    ...
                                    <!-- start modal body -->
                                        <div class="modal-body">
                                            <form action="{{ route('certificat_par_mois') }}" method="POST">
                                                @csrf
                            ...
                            <div class="modal fade" data-backdrop="static" id="par_jour" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <!-- start modal body -->
                                            <div class="modal-body">
                                                    <form action="{{ route('certificat_par_jour') }}" method="post">
                                                        {{ csrf_field() }}
                                                        <div class="form-group">
                        ...
                        <tbody>
                            @foreach ($all_certificats as $certificat)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('certificat_nationalite.show',$certificat->id) }}" class="btn btn-info">Afficher <i class="fa fa-eye"></i></a>

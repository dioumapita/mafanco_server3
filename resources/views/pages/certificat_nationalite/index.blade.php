...
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>
                    Certificat de nationalité du {{ date('d/m/').$annee }} <br><br>
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <a href="{{ route('home') }}" class="btn btn-primary"><i class="fa fa-reply"></i>
                            Retour
                        </a>
                        ...
                        <tbody>
                            @foreach ($all_certificats as $certificat)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('certificat_nationalite.show',$certificat->id) }}" class="btn btn-info btn-block">Afficher <i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

                            ...
                            <tbody>
                                @foreach ($all_plumitifs as $plumitif)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $plumitif->date }}</td>
                                        <td class="text-center">{{ $plumitif->affaire }}</td>
                                        <td class="text-center">{{ $plumitif->objet }}</td>
                                        <td>
                                            <a href="{{ route('plumitif_civil.show',$plumitif->id) }}" class="btn btn-info btn-block">Afficher <i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

            ...
            <div class="card card-topline-red">
                ...
                <div class="card-body ">
                    ...
                    <div class="table-scrollable">
                            ...
                            <input type="search" class="form-control" wire:model='searchDateHeredite' placeholder="Date"> &nbsp;
                            ...
                            <tbody>
                                @foreach ($all_heredites as $heredite)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('heredite.show',$heredite->id) }}" class="btn btn-info btn-block">Afficher <i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

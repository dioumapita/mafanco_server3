        ...
        <div class="profile-sidebar">
            <div class="card">
                <div class="card-head card-topline-aqua">
                    <header>Héredite non indexé: {{ $nbre_heredite}}</header>
                </div>
                ...
                <div class="card-body no-padding height-9">
                    <ul class="list-group list-group-unbordered">
                        <form wire:submit.prevent='indexer()'>
                            ...
                            <input type="text" class="form-control" wire:model="date_heredite" id="date_heredite" placeholder="Date" required> <br>
                            <textarea wire:model="affaire" id="" cols="30" rows="3" class="form-control" placeholder="affaire" required></textarea> <br>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="white-box">
                                ...
                                <br><br>
                                @if($name_file)
                                    <iframe  src="/uploads/bannette/doc_heredite/{{ $name_file }}" width="600" height="700" alt="pdf">
                                    </iframe>
                                @endif
                            </div>
                        </div>

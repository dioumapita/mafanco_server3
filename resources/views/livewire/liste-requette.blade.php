            ...
            <div class="card card-topline-red">
                ...
                <div class="card-body ">
                    ...
                    <div class="table-scrollable">
                            ...
                            <input type="search" class="form-control" wire:model='searchDateRequette' placeholder="Date"> &nbsp;
                            <input type="search" class="form-control"  wire:model='searchRequerant' placeholder="Réquerant">&nbsp;
                        ...
                        <table
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Réquerant</th>
                            ...
                            <tbody>
                                @foreach ($all_requettes as $requette)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $requette->date_requette }}</td>
                                        <td class="text-center">{{ $requette->requerant }}</td>
                                        <td class="text-center">{{ $requette->objet }}</td>
                                        <td>
                                            <a href="{{ route('requette.show',$requette->id) }}" class="btn btn-info btn-block">Afficher <i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

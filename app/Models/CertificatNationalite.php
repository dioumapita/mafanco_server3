...
class CertificatNationalite extends Model
{
    ...
    protected $fillable = ['num','date_demande','copie','num_copie','date_copie','prenom_nom','date_naiss','lieu','pere','mere','domicile','article','signateur','fonction','type','users_id','annee_id','profession'];
